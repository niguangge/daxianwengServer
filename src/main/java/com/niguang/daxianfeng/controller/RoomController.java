...
public class RoomController {
	...
	public @ResponseBody Room createRoom(Model model, HttpServletRequest request, @RequestParam("userId") Long userId)
			throws Exception {
	...
	public @ResponseBody int joinRoom(Model model, HttpServletRequest request, @RequestParam("userId") Long userId,
	...
	public @ResponseBody int leaveRoom(Model model, HttpServletRequest request, @RequestParam("userId") Long userId,
			@RequestParam("roomId") int roomId) throws Exception {
		return roomService.leaveRoom(roomId, userId);
	}

	@RequestMapping(value = "getUserBelong", method = RequestMethod.POST)
	public @ResponseBody int getUserBelong(Model model, HttpServletRequest request, @RequestParam("userId") Long userId)
			throws Exception {
